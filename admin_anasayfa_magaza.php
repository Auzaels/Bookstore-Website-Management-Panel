...
<head>
   ...
   <title>Yönetim Paneli: Anasayfa/Mağaza</title>
...
<header class="homepage-header">
   <div class="homepage-flex">
      <div class="homepage-menu">
         ...
         <a href="admin_anasayfa_magaza.php?duzeltmenu=<?php echo $anasayfaMenu['bolum_id']; ?>" name="menu_duzelt" class="option-btn">Düzenle</a>
      </div>
   </div>
</header>
    ...
    ?>
                ...
                <h1 style="text-align:center;padding-bottom:5px;">Menü - Düzenleme Formu</h1>
                    <table>
                        ...
                        <a href="admin_anasayfa_magaza.php"><input type="button" value="İptal" class="cancel-btn"></a>
                </form>
    <?php
            }
        }
...
<div class="heading">
   <h3>Mağaza</h3>
   <p><a href="admin_anasayfa.php">Anasayfa</a> / Mağaza</p>
</div>
...
<section class="homepage-footer">
   ...
   <a href="admin_anasayfa_magaza.php?duzeltaltbolum=<?php echo $anasayfaAltBasliklar['altbolum_id']; ?>" name="altbolum_duzelt" class="option-btn">Düzenle</a>
</section>
